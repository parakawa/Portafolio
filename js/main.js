...
function invidentes(){
  alert("Estás en la versión para invidentes, pasa el mouse por algún texto para escuchar");
  ...
  $("#creditos").attr("onmouseover", "leerDiv(this)");
  $("#creditos").attr("onmouseout", "stop()");
}
